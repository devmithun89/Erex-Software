        ...
        <div className="relative flex justify-between lg:py-16 lg:px-8">
          <div className="absolute z-40 flex items-center justify-center w-full h-full px-4 overflow-hidden ">
            <div
              ...
              <input
                className="h-auto rounded-[60px]  px-6 focus:outline-none placeholder:text-sm  placeholder-litetext 
          ...
          <div className="w-1/3  lg:w-2/5 xl:w-1/2 bg-skybluelite rounded-l-[75px] flex-col flex justify-center items-center">
            <div className="absolute lg:left-2 lg:w-24 -bottom-2 -left-2 md:-bottom-2  md:w-16 md:h-16 lg:h-24 bg-yellowlite rounded-bl-[85%] -z-10 lg:bottom-10 "></div>

            <div className="flex flex-col md:gap-4">
              <h3 className="hidden text-2xl font-medium text-black md:block md:pl-6 lg:pl-10 md:text-3xl lg:text-4xl font-roboto ">
                Subscribe Newsletter
              </h3>
              <p className="hidden font-normal md:block md:text-xs md:pl-6 lg:pl-10 lg:text-base xl:text-base font-roboto text-litetext">
                I will update good news and promotion service not spam
              </p>
            </div>
          </div>
