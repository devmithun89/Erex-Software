...
export default function Hero() {
  return (
    <>
      <div className="flex flex-col-reverse items-center justify-between w-full py-6 md:pl-16 lg:py-10 md:flex md:flex-row">
        <div className="w-[100%]  z-10  px-8 md:px-0 md:pl-4 md:gap-6 lg:gap-10 gap-6 pt-16 md:pt-8 flex flex-col items-start relative">
          ...
          <button className="px-8 py-4 bg-primary rounded-[60px]">Contact Now</button>
          <img
